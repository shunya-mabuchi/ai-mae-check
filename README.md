...
ChatGPT / Claude / Gemini上での実サイトQA手順は [docs/extension-site-qa.md](docs/extension-site-qa.md)、SiteAdapterの契約とサイト別E2E確認項目は [docs/site-adapter-contract.md](docs/site-adapter-contract.md) にまとめています。WebLLMの実機確認観点は [docs/webllm-real-device-check.md](docs/webllm-real-device-check.md)、端末別のWebLLM対応環境とモデル互換性の記録は [docs/webllm-compatibility-matrix.md](docs/webllm-compatibility-matrix.md) に分けています。
